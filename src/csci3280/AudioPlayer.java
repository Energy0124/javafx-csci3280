...
public class AudioPlayer {
     ...
     */
    public static void playSound(String filename) throws InterruptedException, IOException {
    /*
     ...
     */
        final MediaAudio samples;
        if (audioDecoder.getChannelLayout() == AudioChannel.Layout.CH_LAYOUT_UNKNOWN) {
