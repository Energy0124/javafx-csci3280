...
public class VideoPlayer {
     ...
     */
    public static void playVideo(String filename,ImageView imageView) throws InterruptedException, IOException {
    /*
        ...
        do {
            ...
            if (picture.isComplete()) {
                image = displayVideoAtCorrectTime(streamStartTime, picture, converter,
                        image, systemStartTime, systemTimeBase, streamTimebase,imageView);
            }
    ...
    private static BufferedImage displayVideoAtCorrectTime(long streamStartTime,
                                                           ...
                                                           final Rational systemTimeBase, final Rational streamTimebase,ImageView imageView)
        ...
        final Image jfxImage=SwingFXUtils.toFXImage(image,null);
